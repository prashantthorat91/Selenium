...
public class TestMapping {
	public static void main(String[] args) {
		Address ad1 = new Address(1,"Pune2","MH");
		Emp e1 = new Emp(1,"AAAAA",19828.2);
		ad1.setEmp(e1);
		
		Configuration configuraton = new Configuration();
		configuraton.addAnnotatedClass(Emp.class).addAnnotatedClass(Address.class);
		SessionFactory sfactory = configuraton.configure("mysql-hibernate.cfg.out.xml").buildSessionFactory();
